...
import tcp_ip.channels.RestEntity;
...
public class RestControl {
    ...
    private RestServiseCommunication restServiseCommunication;
    final
    ...
    public RestControl(AllClientsBase allClientsBase, ServerCommunication serverCommunication) {
        ...
        restServiseCommunication=new RestServiseCommunication();
    ...
    public ResponseEntity<?> createAgent(@RequestBody AgentAuthMessage agentAuthMessage,HttpServletRequest request){
        ...
        if (integer!=null){
            ...
            Agent agent=new Agent(IdCounter.getAndIncrement(),new RestEntity(),agentAuthMessage.getName(),agentAuthMessage.getChats());
    ...
    public ResponseEntity<?> createUser(@RequestBody Map<String,String> userAuthMessage, HttpServletRequest request){
        ...
        if (integer!=null){
            ...
            if(userAuthMessage.containsKey("name")) {
                User user=new User(IdCounter.getAndIncrement(),new RestEntity(),userAuthMessage.get("name"));
